...
If the value is 0 or negative, the character cannot make the check without further help, he is simply too bad at this skill. However, \textit{bonus dice} or \textit{destiny dice} can be used even if the value is negative.
