...
\begin{itemize}
    ...
    \item Benutzt einen Initiative-Tracker. Initiative bestimmt im Kampf die Reihenfolge der Beteiligten. Initiative-Tracker bedeutet, dass diese Reihenfolge für alle sichtbar aufgeschrieben ist. Es ist bei \trans{book_title} für die Spieler wichtig zu wissen, wann sie selbst wieder an der Reihe ist (denn dann verfallen u.A. aufgehobene eigene Handlungen).
\end{itemize}
