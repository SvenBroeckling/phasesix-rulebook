...
\faIcon{flag}\hspace{0.5em}\faIcon{plane}\hspace{0.5em}\faIcon{microchip}\hspace{0.5em}\faIcon{space-shuttle}\hspace{0.5em}    }{}
    ...
    Die Anzahl aller Würfel die der Spieler wirft werden verdoppelt. Der Trank hält 2W6 Minuten an.
...
\faIcon{eye}\hspace{0.5em}\faIcon{chess-rook}\hspace{0.5em}    }{}
    ...
    Ein kunstvoll gefertigter Lederriemen der die Wurfweite von Wurfspeeren (Pilum) verdoppelt,
