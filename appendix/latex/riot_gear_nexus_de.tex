...
\begin{tabular}{@{}ll@{}}
    ...
    \textbf{\trans{encumbrance_label}:} & 1 \\
    \textbf{\trans{protection_label}:} &
B N \footnote{D - Schutz vor dämonischem Wirken, S - Schutz vor Schock, R - Reflektionsschutz, F - Feuerschutz, G - Giftschutz, B - Blutungsschutz, H - Haftender Schutz, K - Schutz vor kritischen Treffern, N - Normaler Schutz}\\
\end{tabular}
