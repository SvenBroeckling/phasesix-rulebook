...
\begin{tcolorbox}
    \subsection*{Asgoraner \hfill \small{0 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Flügler \hfill \small{0 \trans{reputation_label}}}
    \tcblower
\textit{Fliegen}: Flügler lernen in der Kindheit das Fliegen, so wie Menschen das Laufen erlernen. Sie können sich frei in der Luft bewegen.
...
\begin{tcolorbox}
    ...
    \tcblower
\textit{Fliegen}: Doldagor fliegen von Geburt an und bewegen sich frei in der Luft. Das Abheben erfordert einen hohen Absprungpunkt oder Anlauf plus einen erfolgreichen Schnelligkeitswurf. Im Flug ist die Bewegungsreichweite verdoppelt. Fliegen erlaubt eine parallele Aktion wie beim Gehen.

\textit{Sturzflug}: Im Sturzflug ist ein waffenloser Schlag möglich. Pro 5 Meter Flugdistanz in derselben Kampfrunde erhält der Angriff +1 Würfel. Pro 10 Meter Flugdistanz in derselben Kampfrunde erleidet der Doldagor beim Aufprall selbst einen normalen Treffer.
...
\begin{tcolorbox}
    ...
    \tcblower
\textit{Nachtsicht}: Katora haben eine angeborene Nachtsicht. Sie sehen zwar etwas schlechter als Elfen bei Nacht, können sich jedoch gut orientieren. Bei allen \textit{schweren Wahrnehmungsproben} in Dunkelheit erhalten Katora 2 Würfel zusätzlich.
...
\begin{tcolorbox}
    ...
    \tcblower
\textit{Nachtsicht}: Fraxut haben eine angeborene Nachtsicht. Bei allen \textit{Wahrnehmungsproben} in Dunkelheit erhalten Fraxut 2 Würfel zusätzlich.
...
\begin{tcolorbox}
    ...
    \tcblower
\textit{Nachtsicht}: Xordai haben eine angeborene Nachtsicht. Bei allen \textit{Wahrnehmungsproben} in Dunkelheit erhalten Xordai 2 Würfel zusätzlich.
...
\begin{tcolorbox}
    ...
    \tcblower
\textit{Nachtsicht}: Silkanda haben eine angeborene Nachtsicht. Bei allen \textit{Wahrnehmungsproben} in Dunkelheit erhalten Silkanda 2 Würfel zusätzlich.
...
\begin{tcolorbox}
    ...
    \tcblower
\textit{Nachtsicht}: Atiarel haben eine angeborene Nachtsicht. Bei allen \textit{Wahrnehmungsproben} in Dunkelheit erhalten Atiarel 2 Würfel zusätzlich.
...
\begin{tcolorbox}
    ...
    \tcblower
\textit{Nachtsicht}: Ancatir haben eine angeborene Nachtsicht. Bei allen \textit{Wahrnehmungsproben} in Dunkelheit erhalten Ancatir 2 Würfel zusätzlich.
...
\begin{tcolorbox}
    \subsection*{Yadosien \hfill \small{0 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Krieger \hfill \small{10 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Mechanikus \hfill \small{10 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Pirat \hfill \small{11 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Wegelagerer \hfill \small{12 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Gaukler \hfill \small{12 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Medikus \hfill \small{12 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Navigatorausbildung \hfill \small{6 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Esoterik \hfill \small{6 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Botanik \hfill \small{3 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Schnitzen \hfill \small{3 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Meisterliches Selbstbewustsein \hfill \small{30 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Abergläubig \hfill \small{-3 \trans{reputation_label}}}
    \tcblower
Du siehst überall Vorzeichen. Tritt ein Ereignis ein, das du als schlechtes Omen deutest (z.B. eine schwarze Katze, ein zerbrochener Gegenstand oder ein Patzer beim Würfeln mit einer 1), musst du sofort eine Probe auf Logik oder Willenskraft ablegen. Misslingt der Wurf, bist du verunsichert: Dein nächster Wurf erhält einen Malus von -2, es sei denn, du verbringst eine Aktion damit, ein kurzes Schutzritual durchzuführen (Salz werfen, Holz klopfen etc.).
...
\begin{tcolorbox}
    \subsection*{Meisterlicher Kämpfer \hfill \small{30 \trans{reputation_label}}}
    \tcblower
...
\begin{tcolorbox}
    \subsection*{Unglaubliche Reaktion \hfill \small{10 \trans{reputation_label}}}
    \tcblower
Du kannst Fernkampfangriffen ausweichen als währen es Nahkampfangriffe
...
\begin{tcolorbox}
    \subsection*{Meisterliches Ausweichen \hfill \small{30 \trans{reputation_label}}}
    \tcblower
Das Ausweichen erfordert keine Aktion mehr.
...
\begin{tcolorbox}
    \subsection*{Meisterliche Parade \hfill \small{30 \trans{reputation_label}}}
    \tcblower
Das Parieren eines Angriffs kostet keine Aktion mehr.
...
\begin{tcolorbox}
    \subsection*{Waldgeboren \hfill \small{11 \trans{reputation_label}}}
    \tcblower
...
\begin{tabular}{@{}ll@{}}
    ...
    \textbf{Werfen} & +2\\
    \textbf{Schießen} & +2\\
    \textbf{Schlossknacken} & +1\\
    \textbf{Älteres Wissen} & +1\\
\end{tabular}
